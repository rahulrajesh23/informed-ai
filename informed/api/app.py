...
def http_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    error_response = {
        ...
        "type": "HTTPException" if isinstance(exc, HTTPException) else type(exc).__name__,
        "headers": dict(headers) if headers else None,
        "path": request.url.path,
        "method": request.method,
    }

    log.error("HTTP exception occurred: {}, exception: {}", error_response, get_concise_exception_traceback(exc))
...
def general_exception_handler(request: Request, exception: Exception) -> Response:
    ...
    log.error(
        "unhandled exception occurred: {}, exception: {}", error_response, get_concise_exception_traceback(exception)
    )
